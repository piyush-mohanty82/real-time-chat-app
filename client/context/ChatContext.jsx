...
export const ChatProvider = ({children}) => {
    ...
    const [selectedUser,setSelectedUser] = useState(null);//user object -> the user we want to chat
    ...
    },[socket,selectedUser]);//whenever socket or selectedUser changes, we want to resubscribe to messages
